...
"[project]/apps/admin-dashboard/pages/index [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/apps/admin-dashboard/pages/index', file not found");
e.code = 'MODULE_UNPARSABLE';
throw e;
}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/apps/admin-dashboard/pages/index [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

var PAGE_PATH = "/";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    function() {
        return __turbopack_context__.r("[project]/apps/admin-dashboard/pages/index [client] (ecmascript)");
    }
]);
...
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/apps/admin-dashboard/pages/index [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__0zdmjrl._.js.map