...
function DashboardPage() {
  ...
  const isLoading =
    loadingStats || loadingPatients || loadingBeds || loadingAdmissions || loadingDischarges;
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">
            {Math.round(
              ((hospitalStats?.currentlyAdmitted || 0) / (hospitalStats?.totalBeds || 100)) * 100
            )}
            %
          </div>
            ...
            {Object.keys(bedAvailability).map(unit => (
              <div key={unit} className="bed-unit">
                ...
                <div className="bed-count">
                  Available: <strong>{bedAvailability[unit].available}</strong> / Total:{" "}
                  <strong>{bedAvailability[unit].total}</strong>
                  <div className="occupancy-bar">
                    <div
                      style={{
                        width: `${(bedAvailability[unit].available / bedAvailability[unit].total) * 100}%`,
                      }}
      ...
      <div className="page-content">
        ...
        <div className="patients-stats">
          ...
          <div className="stat-item">
            ...
            <strong>{patients.filter(p => p.status === "admitted").length}</strong>
          </div>
          <div className="stat-item">
          ...
          <div className="stat-item">
            ...
            <strong>{patients.filter(p => p.admissionType === "emergency").length}</strong>
          </div>
        </div>
...
function BedManagementPage() {
  ...
  const filteredBedStatus =
    selectedUnit === "all"
      ? bedStatus
      : selectedUnit
        ? { [selectedUnit]: bedStatus[selectedUnit] }
        : {};
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-content">
        <div className="bed-header">
          ...
          <div className="bed-stats-summary">
            <div className="stat-item">
              ...
              <strong>{units.reduce((sum, unit) => sum + (bedStatus[unit]?.total || 0), 0)}</strong>
            </div>
            <div className="stat-item">
              <span>Available Beds:</span>{" "}
              <strong>
                {units.reduce((sum, unit) => sum + (bedStatus[unit]?.available || 0), 0)}
              </strong>
            </div>
            <div className="stat-item">
              ...
              <strong>
                {Math.round(
                  (units.reduce(
                    (sum, unit) =>
                      sum + ((bedStatus[unit]?.total || 0) - (bedStatus[unit]?.available || 0)),
                    0
                  ) /
                    Math.max(
                      units.reduce((sum, unit) => sum + (bedStatus[unit]?.total || 0), 0),
                      1
                    )) *
                    100
                )}
        ...
        {(selectedUnit === "all" ? units : units.filter(unit => unit === selectedUnit)).map(
          unit => (
            <div key={unit} className="bed-unit-section">
              ...
              <div className="bed-grid">
                {Array.from({ length: bedStatus[unit]?.total || 0 }, (_, i) => {
                  const bedNumber = i + 1;
                  const isAvailable =
                    bedStatus[unit]?.availableBeds?.includes(bedNumber) ||
                    ((bedStatus[unit]?.available || 0) >
                      (bedStatus[unit]?.occupiedBeds?.length || 0) &&
                      bedStatus[unit]?.occupiedBeds?.indexOf(bedNumber) === -1);

                  return (
                    <div
                      key={bedNumber}
                      className={`bed-bed ${isAvailable ? "available" : "occupied"}`}
                    >
      ...
      <div className="page-content">
        <div className="er-stats">
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">
              {erPatients.filter(p => p.acuity === "critical").length}
            </div>
          </div>
          <div className="stat-card">
            <h3>Trauma Alerts</h3>
            ...
            <div className="er-patients-list">
              {erPatients.length > 0 ? (
                erPatients.map(patient => (
                  <div
                    key={patient.id}
                    className={`er-patient-card acuity-${patient.acuity.toLowerCase()}`}
                  >
                    <div className="er-patient-info">
                      ...
                      <p>
                        <strong>Mode of Arrival:</strong> {patient.arrivalMode}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Time Waiting:</strong> {patient.waitTime} min
                      </p>
                    </div>
                ...
                <div key={ambulanceId} className="ambulance-item">
                  <div className="ambulance-info">
                    ...
                    <p>
                      ...
                      <span
                        className={`status-${ambulanceStatus[ambulanceId].status.toLowerCase()}`}
                      >
                    ...
                    {ambulanceStatus[ambulanceId].eta && (
                      <p>
                        <strong>ETA:</strong> {ambulanceStatus[ambulanceId].eta} min
                      </p>
                    )}
                    {ambulanceStatus[ambulanceId].patientInfo && (
                      <div className="ambulance-patient-info">
                        <p>
                          <strong>Patient:</strong> {ambulanceStatus[ambulanceId].patientInfo.name}
                        </p>
                        <p>
                          <strong>Condition:</strong>{" "}
                          {ambulanceStatus[ambulanceId].patientInfo.condition}
                        </p>
                      </div>
                    )}
                  </div>
          ...
          <div className="settings-section">
            ...
            >
              ...
              <div className="form-group">
                ...
                <input type="tel" id="phone" defaultValue="(555) 123-4567" className="form-input" />
              </div>
              <div className="form-group">
            ...
            <div className="departments-list">
              <div className="department-item">
                ...
                <div className="department-details">
                  <p>
                    <strong>Head of Department:</strong> Dr. Sarah Chen
                  </p>
                  <p>
                    <strong>Staff Count:</strong> 45 physicians, 120 nurses
                  </p>
                  <p>
                    <strong>Bed Capacity:</strong> 30 beds
                  </p>
                  <p>
                    <strong>Annual Visits:</strong> 85,000+
                  </p>
                </div>
              ...
              <div className="department-item">
                ...
                <div className="department-details">
                  <p>
                    <strong>Head of Department:</strong> Dr. Michael Roberts
                  </p>
                  <p>
                    <strong>Staff Count:</strong> 28 physicians, 65 nurses
                  </p>
                  <p>
                    <strong>Bed Capacity:</strong> 45 beds
                  </p>
                  <p>
                    <strong>Annual Procedures:</strong> 12,000+
                  </p>
              ...
              <div className="department-item">
                ...
                <div className="department-details">
                  <p>
                    <strong>Head of Department:</strong> Dr. Jennifer Lee
                  </p>
                  <p>
                    <strong>Staff Count:</strong> 22 physicians, 48 nurses
                  </p>
                  <p>
                    <strong>Bed Capacity:</strong> 30 beds
                  </p>
                  <p>
                    <strong>Annual Treatments:</strong> 8,500+
                  </p>
                </div>
                <div className="department-actions">
                  <button
          ...
          <div className="settings-section">
            ...
            <div className="policies-list">
              <div className="policy-item">
                ...
                <p>
                  <strong>Category:</strong> Clinical Safety
                </p>
              </div>
              <div className="policy-item">
                ...
                <p>
                  <strong>Category:</strong> Compliance
                </p>
              </div>
              <div className="policy-item">
                ...
                <p>
                  <strong>Category:</strong> Emergency Preparedness
                </p>
              </div>
              <div className="policy-item">
                ...
                <p>
                  <strong>Category:</strong> Pharmacy
                </p>
              </div>
            </div>
            <button
          ...
          <header className="app-header">
            <div className="header-content">
              ...
              <nav className="header-nav">
                ...
                <NavLink to="/er" className="nav-link">
                  ER Dashboard
                </NavLink>
